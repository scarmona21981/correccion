...
exports.calculateUEHAccumulation = void 0;
/**
 ...
 */
const calculateUEHAccumulation = (chambers, pipes) => {
    const errors = [];
    const memo = new Map();
    ...
    const updatedChambers = chambers.map(c => {
        ...
        return {
            ...c,
            uehAcumuladas: { value: accValue, origin: 'calculated' }
        };
    });
...
exports.calculateUEHAccumulation = calculateUEHAccumulation;
